# 3dapter - Default Firmware for MiSTer / PC

The default firmware will allow the 3dapter (Triple Controller) to appear a multiplayer input controller with each controller input acting as it's own separate player/input.
